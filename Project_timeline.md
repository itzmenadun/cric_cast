...
- [ ] Setup Redis for in-memory live match state caching.
- [ ] Initialize Node.js + Fastify backend.
...
- [ ] Initialize React Native (Expo) project for iOS/Android tablets and phones.
...
- [ ] Initialize React.js (Vite) project tailored for a 1920x1080 transparent canvas.
